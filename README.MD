...
O sistema realiza o gerenciamento de **usuários, pessoas e telefones**, seguindo princípios de **SOLID** e **Clean Code**.
...
- Antes de rodar a API, configure o banco localmente ou via Docker:
